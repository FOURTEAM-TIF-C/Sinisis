...
public class Data5Activity extends AppCompatActivity implements ListView.OnItemClickListener{
    ...
    private void show(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                Data5Activity.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Data5Activity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_ALL5);
                return s;
            }
        }
