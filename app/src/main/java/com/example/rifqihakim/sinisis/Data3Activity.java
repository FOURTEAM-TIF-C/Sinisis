...
public class Data3Activity extends AppCompatActivity implements ListView.OnItemClickListener{
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.navigation1:
                        ...
                        Intent intent = new Intent(Data3Activity.this, BerandaActivity.class); //Berpindah activity
                    ...
                    case R.id.navigation2:
                        ...
                        Intent tentang = new Intent(Data3Activity.this, TentangActivity.class); //Berpindah activity
    ...
    private void show(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                Data3Activity.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Data3Activity.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(konfigurasi.URL_GET_ALL3);
                return s;
            }
        }
